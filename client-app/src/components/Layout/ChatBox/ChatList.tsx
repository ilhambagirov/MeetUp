            ...
            <div className={darkmode}>
                <section className='chatlist-friends'>
                    ...
                    <ul className='friends-list'>
                        {users.map(user => (
                            <li onClick={()=> chatStore.setBoxMode(user?.userName)} className='d-flex align-items-center pe-0 ps-0 pt-2 pb-2'>
                                <span className='me-2'>
                                    <img className='friends-profile-img' src={user.image || require('../../../assets/images/user-12.png').default} alt="" />
                                </span>
                                <h3 className='fw-700 mb-0 mt-0 d-flex align-items-center'>
                                    <a className={names}>{user.dsiplayName}</a>
                                </h3>
